...
const iconsignin = document.getElementById('icon-signin'),
      navsignin = document.querySelector('.modal'),
      closebtnlogin = document.querySelector('.auth-form__close-login'),
      closebtnregister = document.querySelector('.auth-form__close-register'),

      overlay = document.querySelector('.modal__form'),
